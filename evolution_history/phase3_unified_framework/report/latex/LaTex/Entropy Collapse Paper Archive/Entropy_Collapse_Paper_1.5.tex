...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{figures/toy_model_plot.png}
\caption{Toy model showing emergent gravity response for different values of the Bruno Constant. Higher constants produce steeper entropy gradients, simulating stronger gravitational emergence.}
\label{fig:toy_model}
\end{figure}
